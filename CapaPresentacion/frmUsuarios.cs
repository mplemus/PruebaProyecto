    ...
    public partial class frmUsuarios : Form
    {
        ...
        private void frmUsuarios_Load(object sender, EventArgs e)
        {
            ...
            foreach (Usuario item in listaUsuario)
            {
                ...
                dgvdata.Rows.Add(new object[] {"",item.IdUsuario,item.Documento,item.NombreCompleto,item.Correo,item.Clave, //item es cada entidad de la clase usuaario en la lsita
                    item.oRol.IdRol,
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            Usuario objusuario = new Usuario() //instancia de la clase usuario en capa entidad
            {
            ...
            {
                bool resultado = new CN_Usuario().Editar(objusuario, out mensaje);//si no es 0 va a editar
        ...
        //para poner la img en la celda del dgv
